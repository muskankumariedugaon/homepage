    ...
    >
      <main className="bg-[#f8f9fc]">
        ...
        <section className="px-3 pt-5 sm:px-5 md:px-7 lg:px-9">
          <div
            className="
              ...
              overflow-hidden rounded-2xl bg-white p-2 shadow-md
              sm:p-3 md:p-3 lg:p-4
            "
          >
            <div
              className="
                relative w-full overflow-hidden rounded-xl bg-gray-100
                h-[170px] sm:h-[220px] md:h-[290px]
                lg:h-[360px] xl:h-[400px]
              "
            >
              <img
                src={sliderImages[currentSlide]}
                alt={`Full Stack Development Banner ${currentSlide + 1}`}
                className="
              ...
              <button
                ...
                className="
                  ...
                  rounded-full bg-white/95 text-[#000080] shadow-lg
                  transition-all duration-300
                  hover:scale-110 hover:bg-white
                  sm:left-5 sm:h-10 sm:w-10
                "
              >
              ...
              <div
                className="
                  absolute bottom-3 left-1/2 flex
        ...
        <section className="px-3 py-2 sm:px-5 md:px-7 lg:px-9">
          <div
            className="
              mx-auto max-w-[1450px] overflow-hidden rounded-2xl
              bg-gradient-to-br from-[#2446d4] via-[#2d4fda] to-[#3158e5]
              px-5 py-7
              sm:px-7 sm:py-8
              md:px-9 md:py-9
              lg:px-8 lg:py-8
              ...
              <div>
                ...
                <div
                  className="
                    ...
                    tracking-wide text-white sm:text-[9px]
                  "
                >
                  <FaCode />
                ...
                <h1
                  className="
                    mt-4 max-w-xl text-2xl font-extrabold
                ...
                <p
                  className="
                    mt-4 max-w-lg
                    text-[10px] leading-4 text-blue-100
                    sm:text-xs sm:leading-5
                    md:text-sm md:leading-5
                  "
                >
                  Learn modern full stack development from scratch and build
                  real-world projects for your dream career — guided by
              ...
              <div className="w-full min-w-0">
                ...
                >
                  ...
                  <span className="text-[9px] text-gray-600">
                    Your first full stack project session is live now! 🚀
                  </span>
                </div>
